...
VALUES ('user-forgot-password-email', '<!doctype html>
<html lang="en">
   <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width,initial-scale=1">
      <meta http-equiv="X-UA-Compatible" content="IE=edge">
      <title>Password Reset — Smart Payments</title>
      <style>
   ...
   <body>
      <div class="preheader">Reset your Smart Payments password.</div>
               ...
               <table role="presentation" class="email-container" width="100%" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                     <td class="content">
                        ...
                        <p class="lead">
                           We received a request to reset the password for your <strong>Smart Payments</strong> account.
                           If you made this request, please click the button below to create a new password.
                        </p>

                        <p class="lead">
                           For security reasons, this link can only be used once and will expire in
                           <strong>${EXPIRATION_TIME}</strong>.
                        </p>

                        <p style="text-align:center; margin:22px 0;">
                           <a href="${RESET_LINK}" class="btn" target="_blank" rel="noopener">
                              Reset your password
                           </a>
                        </p>

                        <p class="lead">If the button doesn’t work, you can copy and paste the following link into your browser:</p>
