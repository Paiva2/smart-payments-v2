UPDATE public.email_templates
    SET html_body = '<!doctype html>
        ...
        <head>
          ...
          <title>Welcome to Smart Payments</title>
          <style>
            ...
            .features { margin:18px 0 0 0; }
            .feature { display:flex; gap:12px; align-items:flex-start; margin-bottom:12px; }
            .feature-icon { width:36px; height:36px; border-radius:8px; background:#f1f5f9; display:flex; align-items:center; justify-content:center; font-size:18px; }
            .feature-text { font-size:14px; color:#475569; }
        ...
        <body>
          <div class="preheader">Welcome to Smart Payments — confirm your email to get started!</div>
                ...
                <table role="presentation" class="email-container" width="100%" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td class="content">
                      ...
                      <p class="lead">Welcome to <strong>Smart Payments</strong> — we’re thrilled you’re here. To get started and unlock all features, please confirm your email address by clicking the button below.</p>

                      <p style="text-align:center; margin:22px 0;">
                        <a href="${ACTIVATION_LINK}" class="btn" target="_blank" rel="noopener">Confirm your email</a>
                      </p>
                      ...
                      <p style="margin-top:18px; font-size:14px; color:#475569;">If you didn''t create an account with Smart Payments, you can safely ignore this email, no actions are required.</p>
                  ...
                  <tr>
                    <td class="footer">
                      <p style="margin:0 0 8px 0;">Thanks for joining,<br/><strong>The Smart Payments Team</strong></p>
                    </td>
                  </tr>
                </table>
              </td>
    ...
    </html>' WHERE name = 'user-email-activation'